...
Modern UI automation framework built with Python, Playwright, Pytest, and Allure. 
Integrated with GitHub Actions for Continuous Integration and reporting.
...
[![CI](https://github.com/siberden/playwright-pytest-automation-framework/actions/workflows/ci.yml/badge.svg?branch=main)](https://github.com/siberden/playwright-pytest-automation-framework/actions)
...
- SQL & database-level test verification
